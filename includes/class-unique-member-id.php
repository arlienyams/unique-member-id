...
class Unique_Member_Id
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Unique_Member_Id_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'unique-member-id';
	 ...
	 *
	 * - Unique_Member_Id_Loader. Orchestrates the hooks of the plugin.
	 * - Unique_Member_Id_i18n. Defines internationalization functionality.
	 * - Unique_Member_Id_Admin. Defines all hooks for the admin area.
	 * - Unique_Member_Id_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Unique_Member_Id_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
